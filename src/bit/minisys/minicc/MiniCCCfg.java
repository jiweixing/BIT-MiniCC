...
public class MiniCCCfg {
	...
	public static String MINICC_SEMANTIC_INPUT_EXT = ".tree";//语法分析
	public static String MINICC_SEMANTIC_OUTPUT_EXT = ".tree2.xml";//语义分析
	// input and output for MiniCCICGen
	public static String MINICC_ICGEN_INPUT_EXT = ".tree2.xml";//语法分析
	public static String MINICC_ICGEN_OUTPUT_EXT = ".ic.txt";//生成四元式列表
	...
	public static String MINICC_CODEGEN_OUTPUT_EXT = ".code.s";//生成x86或MIPS汇编代码
